...
var Gitment = function () {
  ...
  function Gitment() {
    ...
    var mod_id = window.location.href.split("/");
    mod_id = decodeURI(mod_id[mod_id.length - 2]);
    var mod_url = decodeURI(window.location.href);
    var mod_title =window.document.title.split("|")[0];
